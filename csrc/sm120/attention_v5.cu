// attention_v5.cu — Flash Attention v5 kernel for sm_120 (Blackwell PCIe)
// Original: https://github.com/gau-nernst/learn-cuda/blob/e83c256/07_attention/attention_v5.cu
// License: MIT (gau-nernst)
//
// This is the unmodified v5 kernel with a PyTorch C++ extension wrapper added.
// Uses only sm_80 features: cp.async, ldmatrix, mma.m16n8k16
// Achieves 94.4% SOL on RTX 5090 (sm_120).
